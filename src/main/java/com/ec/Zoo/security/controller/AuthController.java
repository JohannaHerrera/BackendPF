package com.ec.Zoo.security.controller;

import com.ec.Zoo.dto.Mensaje;
import com.ec.Zoo.security.dto.JwtDto;
import com.ec.Zoo.security.dto.LoginUsuario;
...
import com.ec.Zoo.security.jwt.JwtProvider;
import com.ec.Zoo.security.service.RolService;
import com.ec.Zoo.security.service.UsuarioService;
    ...
    public ResponseEntity<?> nuevo(@Valid @RequestBody NuevoUsuario nuevoUsuario, BindingResult bindingResult){
        ...
        Usuario usuario =
                new Usuario(nuevoUsuario.getNombre(), nuevoUsuario.getNombreUsuario(), nuevoUsuario.getEmail(),
                        ...
                        nuevoUsuario.getCiudad(), nuevoUsuario.getGenero());
